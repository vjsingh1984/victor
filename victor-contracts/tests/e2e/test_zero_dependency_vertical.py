...
This test verifies that a vertical can be defined using only victor-contracts
...
def test_zero_dependency_import():
    """Test that victor-contracts can be imported without victor-ai."""
    script = """
# This should work without victor-ai installed
from victor_contracts.verticals.protocols.base import VerticalBase
from victor_contracts.core.types import VerticalConfig, StageDefinition
from victor_contracts.discovery import ProtocolRegistry
...
def test_zero_dependency_vertical_definition():
    """Test that a vertical can be defined using only victor-contracts."""
    script = """
from victor_contracts.verticals.protocols.base import VerticalBase
...
def test_discovery_system():
    ...
    script = """
from victor_contracts.discovery import ProtocolRegistry, DiscoveryStats
...
def test_core_types():
    ...
    script = """
from victor_contracts.core.types import VerticalConfig, StageDefinition, TieredToolConfig, ToolSet, Tier
...
def test_exceptions():
    ...
    script = """
from victor_contracts.core.exceptions import VerticalException, VerticalConfigurationError
...
def test_complete_vertical_workflow():
    ...
    script = """
from victor_contracts.verticals.protocols.base import VerticalBase
from victor_contracts.core.types import StageDefinition, Tier
...
# Now verify victor-contracts works independently
from victor_contracts.verticals.protocols.base import VerticalBase
...
print("✓ victor-contracts works independently of victor-ai")
"""
    success, stdout, stderr = run_python_script(script)
    ...
    if "WARNING" in stdout:
        ...
        assert "✓ victor-contracts works independently of victor-ai" in stdout
