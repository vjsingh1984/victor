...
from victor_contracts.core.api_version import CURRENT_API_VERSION
...
from victor_contracts.verticals.mixins import (
...
class VerticalBase(
    ...
    # See victor_contracts.verticals.mixins for the implementations.
    ...
    # are inherited via mixin composition. See victor_contracts.verticals.mixins.
