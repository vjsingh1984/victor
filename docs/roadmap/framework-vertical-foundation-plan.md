...
## Current Tranche (2026-03-04)
### Scope
- FND-001: Fix step-handler contract drift
- FND-002: Implement EventRegistry-driven stream conversion
- FND-007: Add dependency-contract validation for step-handler graphs
- FND-003: Fence legacy extension-registry APIs with migration guidance
- FND-004: Add warm-start env-hash fast path for entry-point cache
- Add tests for all changes

### Planned file touchpoints
- `victor/framework/step_handlers.py`
- `victor/framework/_internal.py`
- `victor/framework/event_registry.py`
- `victor/framework/vertical_integration.py`
- `victor/framework/module_loader.py`
- `tests/unit/framework/test_framework_internal.py`
- `tests/unit/framework/test_vertical_integration.py`
- `tests/unit/framework/test_module_loader.py`
- `docs/development/architecture/framework-vertical-integration.md`
