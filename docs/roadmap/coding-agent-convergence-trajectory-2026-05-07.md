...
- Phase 4: benchmark fixture catalogs, fixture and real-run publication bundles, stable-run KPI sidecars with completeness diagnostics, corpus readiness summaries, CLI publishability gating, runtime-variant summaries, merge-efficiency metrics, workspace-policy/diagnostic rollups, workspace-policy comparison fields, and fixture-input rejection for real-run publication exist; public real-run corpus depth remains the gap.
