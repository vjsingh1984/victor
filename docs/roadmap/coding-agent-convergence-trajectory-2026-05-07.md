...
| --- | --- | --- | --- | --- | --- |
| 1 | Critical | 3 | Productize delegate follow-up ergonomics across surfaces | Workflow/`TeamStep` capability first; chat/TUI only compose it | Users can resume review/retry/merge/cleanup contracts from chat/TUI with concise return contracts and no local duplicate delegate runtime. |
