...
See [Releasing →](releasing/publishing.md) for version bumping and publishing.

## More Details

- [Testing Strategy →](testing/strategy.md) - Fixtures, mocking patterns
- [Architecture Deep Dive →](architecture/deep-dive.md) - System internals
- [Plugin Guide →](extending/verticals.md) - External verticals
