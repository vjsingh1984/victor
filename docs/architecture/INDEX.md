...
**Note**: Legacy refactoring and workflow migration guides have been archived to [archive/migration-guides/](../archive/migration-guides/) for historical reference.
