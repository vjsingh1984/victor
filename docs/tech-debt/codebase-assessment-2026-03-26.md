...
| DES-05 | Vertical integration is a major hotspot despite the contract-first direction. | `victor/framework/vertical_integration.py` is 2522 LOC and still centralizes too much cross-boundary wiring. | High | `victor/framework/vertical_integration.py` |
