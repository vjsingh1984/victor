...
if TYPE_CHECKING:
    from victor.memory.entity_memory import EntityMemory
    from victor.memory.entity_graph import EntityGraph
...
class GraphMemoryAdapter:
    ...
    async def store(
        ...
        Args:
            ...
            metadata: Additional metadata
        """
        from victor.memory.entity_types import EntityRelation, RelationType
