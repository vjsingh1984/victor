...
class TaskTypeRegistry:
    ...
    def add_registration_hook(
        self, hook: Callable[["TaskTypeRegistry"], None]
    ) -> None:
    ...
    def _register_defaults(self) -> None:
        ...
        self.register(TaskTypeDefinition(
            name="edit",
            category=TaskCategory.MODIFICATION,
        ...
        self.register(TaskTypeDefinition(
            ...
            tool_budget=25,
            max_iterations=10,
            priority_tools=["code_search", "semantic_code_search", "read_file", "list_directory"],
...
def register_coding_task_types(registry: TaskTypeRegistry) -> None:
    ...
    registry.register_for_vertical("coding", TaskTypeDefinition(
...
def register_research_task_types(registry: TaskTypeRegistry) -> None:
    ...
    registry.register_for_vertical("research", TaskTypeDefinition(
        name="general_query",
        category=TaskCategory.ANALYSIS,
