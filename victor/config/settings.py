...
class ProviderConfig(BaseSettings):  # type: ignore[misc]
...
class ProfileConfig(BaseSettings):  # type: ignore[misc]
...
class ProfilesYAMLSettingsSource(PydanticBaseSettingsSource):  # type: ignore[misc]
