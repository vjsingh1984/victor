...
class CodebaseIndex:
    ...
    def _initialize_embeddings(self, config: Optional[Dict[str, Any]]) -> None:
        ...
        """
        try:
            from victor.coding.codebase.embeddings import EmbeddingConfig, EmbeddingRegistry
    ...
    async def semantic_search(
        ...
        if expand_query:
            from victor.coding.codebase.query_expander import expand_query as expand_fn
