...
from victor.coding.security.cve_database import BaseCVEDatabase, get_cve_database
from victor.coding.security.protocol import (
    Dependency,
    SecurityScanResult,
    Vulnerability,
    VulnerabilityStatus,
...
class BaseSecurityDependencyParser(ABC):
    ...
    - BasePackageDependencyParser (victor.coding.deps.parsers): Package management with PackageManager
    """
