...
Example usage:
    from victor.coding.refactor import get_refactor_manager, RefactorType
...
from victor.coding.refactor.transforms import (
    BaseTransform,
    CodeTransform,
...
from victor.coding.refactor.manager import (
    RefactorManager,
