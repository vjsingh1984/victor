...
Example usage:
    from victor.coding.review import get_review_manager, ReviewConfig
    ...
    # Configure rules
    from victor.coding.review import get_rule_registry
...
from victor.coding.review.rules import (
    DEFAULT_RULES,
    DEFAULT_RULESETS,
    RuleRegistry,
    get_rule_registry,
...
from victor.coding.review.manager import (
    ReviewManager,
    get_review_manager,
