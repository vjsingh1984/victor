...
Example usage:
    from victor.coding.docgen import get_docgen_manager, DocConfig, DocFormat
...
from victor.coding.docgen.parser import (
    BaseDocstringParser,
    CodeAnalyzer,
    GoogleDocstringParser,
    NumpyDocstringParser,
)
from victor.coding.docgen.formatter import (
    BaseFormatter,
    HTMLFormatter,
    MarkdownFormatter,
    RSTFormatter,
...
from victor.coding.docgen.manager import (
    DocGenManager,
    get_docgen_manager,
