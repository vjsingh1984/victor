...
"""DEPRECATED: UnifiedChatCoordinator has moved to services.

.. deprecated::
    Import UnifiedChatCoordinator from victor.agent.services.unified_chat_compat instead.
...
__all__ = ["UnifiedChatCoordinator"]
