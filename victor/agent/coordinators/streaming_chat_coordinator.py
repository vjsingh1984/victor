...
"""DEPRECATED: StreamingChatCoordinator has moved to services.

.. deprecated::
    Import StreamingChatCoordinator from victor.agent.services.streaming_chat_compat instead.
...
__all__ = ["StreamingChatCoordinator"]
