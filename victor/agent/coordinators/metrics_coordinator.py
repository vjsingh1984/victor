...
"""DEPRECATED: MetricsCoordinator has moved to services.

.. deprecated::
    Import MetricsCoordinator from victor.agent.services.metrics_service instead.
...
warnings.warn(
    "victor.agent.coordinators.metrics_coordinator is deprecated. "
    "Import MetricsCoordinator from victor.agent.services.metrics_service instead.",
    DeprecationWarning,
    stacklevel=2,
)
