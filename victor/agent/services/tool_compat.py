...
"""Service-owned compatibility runtime for deprecated tool coordination.

This module hosts the deprecated ToolCoordinator compatibility shim while the
canonical active runtime remains ToolService.

The legacy `victor.agent.coordinators.tool_coordinator` module now re-exports
