...
class AgentCapabilities:
    ...
    def allows_tool(self, tool_name: str) -> bool:
        ...
        for pattern in self.tool_patterns:
            if fnmatch.fnmatch(canonical_tool_name, pattern) or fnmatch.fnmatch(
                tool_name, pattern
            ):
                return True
        return False
...
class AgentSpec:
    ...
    def with_capabilities(
        ...
        **kwargs: Any,
        ...
        new_caps = AgentCapabilities(
            ...
            tool_patterns=self.capabilities.tool_patterns
            + kwargs.pop("tool_patterns", []),
    ...
    def with_constraints(self, **kwargs: Any) -> "AgentSpec":
        ...
        new_constraints = AgentConstraints(
            ...
            required_tools=self.constraints.required_tools
            | set(kwargs.get("required_tools", [])),
        )
        return AgentSpec(
            name=self.name,
            description=self.description,
