...
from victor.verticals.protocols import ServiceProviderProtocol
...
class CodingServiceProvider(ServiceProviderProtocol):
    ...
    def _register_middleware(
        ...
        def create_middleware(_):
            from victor.verticals.coding.middleware import CodeCorrectionMiddleware
    ...
    def _register_tool_dependencies(
        ...
        from victor.core.container import ServiceLifetime
        from victor.verticals.protocols import ToolDependencyProviderProtocol

        def create_tool_deps(_):
            from victor.verticals.coding.tool_dependencies import (
