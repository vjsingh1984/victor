...
Example:
    from victor.verticals.devops.teams import (
        get_team_for_task,
        DEVOPS_TEAM_SPECS,
    )
...
def _auto_register_teams() -> int:
    """Auto-register DevOps teams with global registry.
    ...
    try:
        ...
        logger.debug(f"Auto-registered {count} DevOps teams")
        return count
    except Exception as e:
        logger.warning(f"Failed to auto-register DevOps teams: {e}")
        return 0
