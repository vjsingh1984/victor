...
class FireworksProvider(BaseProvider):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._provider_logger = ProviderLogger("fireworks", __name__)

        # Resolve API key using unified resolver
        resolver = UnifiedApiKeyResolver(non_interactive=non_interactive)
        key_result = resolver.get_api_key("fireworks", explicit_key=api_key)
        ...
        self._provider_logger.log_provider_init(
            model="fireworks",  # Will be set on chat()
    ...
    async def chat(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            model: Model name (e.g., "accounts/fireworks/models/llama-v3p3-70b-instruct")
            temperature: Sampling temperature
            max_tokens: Maximum tokens to generate
            tools: Available tools
            **kwargs: Additional Fireworks parameters
