...
2. DOCUMENTATION PARITY (MANDATORY): At the end of every refactoring or feature implementation, you MUST bring the project documentation into parity with the code changes using `sync_documentation` or manual edits.
