    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        ...
        for extension_type, (module_suffix, class_suffix) in cls._extension_patterns.items():
            ...
            if method_name not in cls.__dict__:
                ...
                def _make_getter(ext_type: str, mod_suffix: str, cls_suffix: str) -> classmethod[Any]:  # type: ignore[type-arg]
        ...
        for extension_type in cls._cached_extensions:
            ...
            if method_name not in cls.__dict__:
                ...
                def _make_cached_getter(ext_type: str) -> classmethod[Any]:  # type: ignore[type-arg]
