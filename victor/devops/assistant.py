...
class DevOpsAssistant(VerticalBase):
    ...
    def get_tool_dependency_provider(cls) -> ToolDependencyProviderProtocol | None:
        ...
        def _create() -> "ToolDependencyProviderProtocol | None":
    ...
    def get_handlers(cls) -> Dict[str, Any]:
        ...
        devops_handlers = registry.list_by_vertical("devops")
        if not devops_handlers:
            registry.discover_from_vertical("devops")

        handlers = {}
        for handler_name in registry.list_by_vertical("devops"):
