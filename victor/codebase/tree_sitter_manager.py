...
import warnings
warnings.warn("Importing from 'victor.codebase.tree_sitter_manager' is deprecated. Please use 'victor_coding.codebase.tree_sitter_manager' instead.", DeprecationWarning, stacklevel=2)
