...
PATTERNS = [
    ...
    (
        r"(\W): ItemsView\s*\[([^\]]+)\]",
        r"\1: ItemsView[\2, Any]",
        "ItemsView with 1 arg to 2 args",
    ),
    # ObjectPool fixes
    (
        r"(\W): ObjectPool\s*([,\)\]\}])",
        r"\1: ObjectPool[Any]\2",
        "bare ObjectPool to ObjectPool[Any]",
    ),
    # LRUCache fixes
    (
        r"(\W): LRUCache\s*([,\)\]\}])",
        r"\1: LRUCache[Any, Any]\2",
        "bare LRUCache to LRUCache[Any, Any]",
    ),
    # TimedCache fixes
    (
        r"(\W): TimedCache\s*([,\)\]\}])",
        r"\1: TimedCache[Any, Any]\2",
        "bare TimedCache to TimedCache[Any, Any]",
    ),
]
