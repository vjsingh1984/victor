...
class BenchmarkAnalyzer:
    ...
    def generate_full_report(self, output_path: str = None) -> str:
        ...
        report_parts = [
            ...
            "",
            "# Save results",
            "pytest tests/benchmark/test_embedding_operations_baseline.py --benchmark-save=baseline",
            "",
            "# Compare with previous run",
            "pytest tests/benchmark/test_embedding_operations_baseline.py --benchmark-compare=baseline",
            "",
            "# Generate histogram",
            "pytest tests/benchmark/test_embedding_operations_baseline.py --benchmark-histogram",
            "```",
            "",
            "---",
            "",
