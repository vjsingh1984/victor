...
class TestContainerOpsHandler:
    ...
    @pytest.fixture
    def handler(self):
        from victor.devops.handlers import ContainerOpsHandler
...
class TestTerraformHandler:
    ...
    @pytest.fixture
    def handler(self):
        from victor.devops.handlers import TerraformHandler
...
class TestHandlerRegistration:
    ...
    def test_register_handlers(self):
        ...
        from victor.devops.handlers import register_handlers
...
class TestEscapeHatches:
    ...
    def test_deployment_ready_all_valid(self):
        ...
        from victor.devops.escape_hatches import deployment_ready
    ...
    def test_health_check_status_healthy(self):
        ...
        from victor.devops.escape_hatches import health_check_status
    ...
    def test_rollback_needed_on_failure(self):
        ...
        from victor.devops.escape_hatches import rollback_needed
    ...
    def test_container_build_status_success(self):
        ...
        from victor.devops.escape_hatches import container_build_status
    ...
    def test_security_scan_verdict_pass(self):
        ...
        from victor.devops.escape_hatches import security_scan_verdict
