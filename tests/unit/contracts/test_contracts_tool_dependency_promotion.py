"""TDD tests for tool dependency promotion to victor-contracts.

These tests verify that base tool dependency implementations are
importable from victor_contracts, enabling external verticals to stop
...
class TestToolDependencySDKExports:
    ...
    def test_exports_in_verticals_init(self):
        from victor_contracts.verticals import tool_dependencies
