...
class TestLazyNodeIteration:
    ...
    @pytest.mark.asyncio
    async def test_iter_nodes_with_filter(
    ...
    @pytest.mark.asyncio
    async def test_iter_nodes_single_batch(
        self, populated_graph_store: SqliteGraphStore
    ):
...
class TestLazyEdgeIteration:
    ...
    @pytest.mark.asyncio
    async def test_iter_edges_multiple_types(
        self, populated_graph_store: SqliteGraphStore
    ):
...
class TestLazyNeighborIteration:
    ...
    @pytest.mark.asyncio
    async def test_iter_neighbors_filtered(
        self, populated_graph_store: SqliteGraphStore
    ):
    ...
    @pytest.mark.asyncio
    async def test_iter_neighbors_invalid_direction(
        self, populated_graph_store: SqliteGraphStore
    ):
...
class TestLazyLoadingIntegration:
    ...
    async def test_retriever_lazy_fallback(
        ...
        mock_store.iter_neighbors = MagicMock(
            side_effect=Exception("Lazy loading failed")
        )
