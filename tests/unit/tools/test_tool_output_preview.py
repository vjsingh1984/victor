...
def test_integration_edit_preview_shows_diff():
...
def test_integration_read_preview_shows_file_header():
...
def test_integration_ls_preview_shows_item_count():
...
def test_integration_failed_tool_no_preview():
