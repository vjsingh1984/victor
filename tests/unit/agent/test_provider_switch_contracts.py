...
def test_factory_code_uses_provider_package_instead_of_root_switch_module():
    ...
    assert "from victor.agent.provider_switch_coordinator import ProviderSwitchCoordinator" not in runtime_builders_source
    assert "from victor.agent.provider_switch_coordinator import ProviderSwitchCoordinator" not in orchestrator_factory_source
