...
class TestMessageHistory:
    ...
    def test_ensure_system_prompt(self) -> None:
        ...
        manager = MessageHistory(system_prompt="System instructions")
    ...
    def test_get_messages_for_provider(self) -> None:
        ...
        manager = MessageHistory(system_prompt="Be helpful")
    ...
    def test_to_dict_and_from_dict(self) -> None:
        ...
        manager = MessageHistory(system_prompt="Test system", max_history_messages=50)
        manager.ensure_system_prompt()
        manager.add_user_message("Hello")
