...
class TestRefactorRenameSymbol:
    ...
    async def test_rename_symbol_missing_file(self):
        ...
        result = await refactor_rename_symbol(file="", old_name="test", new_name="new_test")
    ...
    async def test_rename_symbol_missing_old_name(self):
        ...
        result = await refactor_rename_symbol(file="test.py", old_name="", new_name="new_test")
    ...
    async def test_rename_symbol_missing_new_name(self):
        ...
        result = await refactor_rename_symbol(file="test.py", old_name="test", new_name="")
    ...
    async def test_rename_symbol_file_not_found(self):
        ...
        result = await refactor_rename_symbol(
            file="/nonexistent/file.py", old_name="old", new_name="new"
        )
    ...
    async def test_rename_symbol_not_python_file(self, tmp_path):
        ...
        result = await refactor_rename_symbol(file=str(test_file), old_name="old", new_name="new")
...
"""
        ...
        result = await refactor_rename_symbol(
            file=str(test_file), old_name="old_function", new_name="new_function", preview=True
        )
...
"""
        ...
        result = await refactor_rename_symbol(
            file=str(test_file), old_name="calculate", new_name="compute", preview=False
        )
...
"""
        ...
        result = await refactor_rename_symbol(
            file=str(test_file), old_name="nonexistent", new_name="new_name"
        )
...
"""
        ...
        result = await refactor_rename_symbol(
            file=str(test_file), old_name="OldClass", new_name="NewClass", preview=True
        )
...
"""
        ...
        result = await refactor_rename_symbol(
            file=str(test_file), old_name="Calculator", new_name="MathCalculator", preview=False
        )
...
class TestRefactorExtractFunction:
    ...
    async def test_extract_function_not_python_file(self, tmp_path):
        ...
        result = await refactor_extract_function(
            file=str(test_file), start_line=1, end_line=1, function_name="extracted"
        )
...
"""
        ...
        result = await refactor_extract_function(
            file=str(test_file), start_line=3, end_line=4, function_name="filter_and_sort"
        )
...
class TestRefactorInlineVariable:
    ...
    async def test_inline_variable_missing_file(self):
        """Test handling of missing file parameter."""
        result = await refactor_inline_variable(file="", variable_name="var")
    ...
    async def test_inline_variable_missing_variable_name(self):
        ...
        result = await refactor_inline_variable(file="test.py", variable_name="")
    ...
    async def test_inline_variable_file_not_found(self):
        """Test handling of non-existent file."""
        result = await refactor_inline_variable(file="/nonexistent/file.py", variable_name="var")
    ...
    async def test_inline_variable_not_python_file(self, tmp_path):
        ...
        result = await refactor_inline_variable(file=str(test_file), variable_name="var")
    ...
    async def test_inline_variable_not_found(self, tmp_path):
        ...
        result = await refactor_inline_variable(file=str(test_file), variable_name="nonexistent")
