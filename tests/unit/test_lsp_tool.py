...
class TestLspStatus:
    ...
    async def test_status_success(self):
        ...
        with patch("victor.lsp.manager.get_lsp_manager", return_value=mock_manager):
...
class TestLspStart:
    ...
    async def test_start_unknown_language(self):
        ...
        with patch("victor.lsp.manager.get_lsp_manager", return_value=mock_manager):
            with patch("victor.lsp.config.LANGUAGE_SERVERS", {}):
    ...
    async def test_start_success(self):
        ...
        with patch("victor.lsp.manager.get_lsp_manager", return_value=mock_manager):
            with patch("victor.lsp.config.LANGUAGE_SERVERS", {"python": mock_config}):
