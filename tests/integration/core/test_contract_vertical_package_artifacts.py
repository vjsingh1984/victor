...
def test_victor_contracts_wheel_and_sdist_include_contract_files(tmp_path: Path) -> None:
    """victor-contracts artifacts should ship the contract surface used by vertical authors."""
    ...
    wheel_required_suffixes = {
        "victor_contracts/__init__.py",
        "victor_contracts/constants/tool_names.py",
        "victor_contracts/constants/capability_ids.py",
        "victor_contracts/core/types.py",
        "victor_contracts/verticals/extensions.py",
...
def test_external_vertical_wheel_and_sdist_include_entry_point_and_sources(
    ...
    """The contract-only example should package its entry point and source files correctly."""
