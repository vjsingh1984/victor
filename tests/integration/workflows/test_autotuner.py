...
class TestPerformanceAnalyzer:
    ...
    def test_analyze_performance_with_slow_execution(self, sample_metrics):
    ...
    def test_analyze_performance_with_high_latency_outliers(self, sample_metrics):
    ...
    def test_analyze_performance_with_low_success_rate(self, sample_metrics):
    ...
    def test_analyze_performance_with_excessive_tool_usage(self, sample_metrics):
    ...
    def test_analyze_formation_performance(self, sample_metrics):
    ...
    def test_load_metrics_from_file(self, sample_metrics, tmp_path):
...
class TestOptimizationStrategies:
    ...
    def test_team_sizing_strategy(self, sample_metrics):
    ...
    def test_formation_selection_strategy(self):
    ...
    def test_tool_budget_strategy(self):
    ...
    def test_timeout_tuning_strategy(self):
    ...
    def test_apply_team_sizing(self, sample_workflow_config):
    ...
    def test_apply_formation_selection(self, sample_workflow_config):
...
class TestPerformanceAutotuner:
    ...
    def test_suggest_optimizations(self, sample_metrics, sample_workflow_config):
    ...
    @pytest.mark.asyncio
    async def test_rollback_optimization(self, sample_metrics, sample_workflow_config):
    ...
    @pytest.mark.asyncio
    async def test_rollback_nonexistent_team(self):
    ...
    def test_get_optimization_history(self, sample_metrics, sample_workflow_config):
    ...
    def test_optimization_result_to_dict(self, sample_workflow_config):
...
class TestAutotunerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_complete_autotuning_workflow(self, sample_metrics, sample_workflow_config):
    ...
    @pytest.mark.asyncio
    async def test_ab_test_threshold_validation(self, sample_metrics, sample_workflow_config):
    ...
    def test_strategy_configuration(self, sample_metrics):
